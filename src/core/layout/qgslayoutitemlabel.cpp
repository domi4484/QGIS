...
//          webEngineView.resize( QSize( painterRect.width() * mHtmlUnitsToLayoutUnits * 10.0, painterRect.height() * mHtmlUnitsToLayoutUnits * 10.0 ) );
//          webEngineView.setStyleSheet( createStylesheet() );
//          webEngineView.setHtml(currentText());
