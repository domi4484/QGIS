...
class CORE_EXPORT QgsSettingsRegistryCore : public QgsSettingsRegistry
{
  public:
    ...
    static const inline QgsSettingsEntryString settingsLayoutDesignerDefaultFont = QgsSettingsEntryString( QStringLiteral( "defaultFont" ), QgsSettings::Prefix::GUI_LAYOUTDESIGNER, QString() );
