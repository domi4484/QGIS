...
class GUI_EXPORT QgsCodeEditor : public QsciScintilla
{
  ...
  public:
    ...
    static const inline QgsSettingsEntryString settingsCodeEditorFontfamily = QgsSettingsEntryString( QStringLiteral( "fontfamily" ), QgsSettings::Prefix::GUI_CODEEDITOR, QString() ) SIP_SKIP;
